...
namespace MyAkademiECommerce.IdentityServer
{
    public static class Config
    {
        public static IEnumerable<ApiResource> ApiResources => new ApiResource[]
        {
            ...
            new ApiResource("ResourceDsicount"){Scopes={"DiscountReadPermission","DiscountCreatePermission"}},
            new ApiResource ("ResourceDiscoutnFull"){Scopes={"DiscountFullPermission"}},
